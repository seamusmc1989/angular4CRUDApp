...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tasks_tasks_add_tasks_add_component__ = __webpack_require__("../../../../../src/app/tasks/tasks-add/tasks-add.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__tasks_tasks_list_tasks_list_component__ = __webpack_require__("../../../../../src/app/tasks/tasks-list/tasks-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__tasks_task_service__ = __webpack_require__("../../../../../src/app/tasks/task.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__tasks_tasks_add_tasks_add_component__["a" /* TasksAddComponent */],
                __WEBPACK_IMPORTED_MODULE_8__tasks_tasks_list_tasks_list_component__["a" /* TasksListComponent */]
            ],
            imports: [
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_9__tasks_task_service__["a" /* TaskService */]
            ],
...
var TasksAddComponent = /** @class */ (function () {
    ...
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new __WEBPACK_IMPORTED_MODULE_2__task_model__["a" /* Task */](event.target.value, false, this.getTodaysDateAsString());
    ...
    TasksAddComponent.prototype.getTodaysDateAsString = function () {
        var today = new Date();
...
var TasksListComponent = /** @class */ (function () {
    ...
    TasksListComponent.prototype.ngOnInit = function () {
        ...
        function (task) { return _this.tasks.push(task); });
    };
